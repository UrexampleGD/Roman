-- This script was made by Jude, my best friend but sadly, he never came back..

Player = game:GetService("Players").LocalPlayer

if Player.Name ~= "CurseDew" and Player.Name ~= "faster4lifez" then
...
--For this layer, this was made by EmpAathy
        RW.Part0 = ch.Torso
...
-- Look enable this if u want to lmao
